        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Admin Profile
                <form action="backend.php" method="POST">
                    <button type="submit" name="delete-admin-multiple" class="btn btn-danger">Delete Multiple Data</button>
                </form>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    <td>
                                        <input type="checkbox" onclick="toggleCheckbox(this)" value="<?php echo $row['admin_id'];  ?>" <?php echo $row['visible'] == 1 ? "checked" : "" ?>>
                                    </td>
                                    ...
                                    <td>
                                        <form action="admin-info-edit.php" method="post">
...
<script src="js/admin-multi.js"></script>
